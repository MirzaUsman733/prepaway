          ...
          <div className="col-12 col-md-6 col-lg-4">
            <div className="">
              ...
              <Form layout="vertical">
                ...
                >
                  <button
                    className="authFormBtn btn btn-warning text-uppercase"
                  >
                    Register Now
                  </button>
                  <div className="fs-5 mt-3 blueColor text-center">
                    <Link to="/signup" className='text-decoration-none text-primary'>Register New Account</Link>
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div className="authLastDiv text-center">
              ...
              <div className="text-center">
                <button className="lastDivBtn btn btn-success text-start mt-5">
                  Sign Up{' '}
                  <span className="formBtnIcon1">
                    <MdNavigateNext size={30} color="white" />
                  </span>
                </button>
                <button className="lastDivBtn btn btn-warning text-start mt-3">
                  Learn More{' '}
                  <span className="formBtnIcon2">
                    <MdNavigateNext size={30} color="white" />
                  </span>
                </button>
                <button className="lastDivBtn btn btn-primary text-start mt-3">
                  Full Version{' '}
